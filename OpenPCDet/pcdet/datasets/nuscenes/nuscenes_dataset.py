...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default='autodl-tmp/BEVCar/OpenPCDet/tools/cfgs/dataset_configs/nuscenes_dataset.yaml', help='specify the config of dataset')
